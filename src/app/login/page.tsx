...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen flex font-nunito bg-base">
      ...
      <div className="relative hidden w-[45%] flex-col overflow-hidden bg-gray-900 p-12 lg:flex">
        ...
        <p className="text-xs text-gray-600">© 2026 MilestoneHit</p>
      </div>

      {/* Right — form */}
      <div className="flex flex-1 flex-col">
        {/* Mobile header */}
        <div className="flex h-14 items-center justify-between border-b px-6 lg:hidden border-edge">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-indigo-600">
              <Zap size={14} className="text-white" fill="white" />
            </div>
            <span className="text-sm font-semibold font-poppins text-ink">
              MilestoneHit
            </span>
          </Link>
        </div>
