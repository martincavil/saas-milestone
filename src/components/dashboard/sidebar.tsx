...
import {
  LayoutDashboard, Trophy, Send, Plug, Settings,
  Zap, LogOut, CreditCard, Lock, ChevronRight,
} from 'lucide-react'
...
export function Sidebar({ email, isSubscribed }: SidebarProps) {
  ...
  return (
    <aside className="flex h-screen w-56 flex-shrink-0 flex-col border-r border-white/8 bg-[#0d0d10]">
      {/* Logo */}
      ...
      <nav className="flex flex-col gap-1 p-3 flex-1 overflow-y-auto">
        ...
        {!isSubscribed && (
          <div className="mt-4 rounded-xl border border-indigo-500/20 bg-indigo-500/8 p-3">
            <p className="text-xs font-semibold text-indigo-300 mb-1">Unlock Pro</p>
            <p className="text-xs text-white/35 mb-2.5">Overview, posting, and full analytics.</p>
            <Link
