      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-amber-300">
            You've crossed $100 MRR
          </p>
          <p className="text-xs text-amber-400/60 mt-0.5">
            Upgrade to keep posting milestones automatically.
          </p>
        </div>
      </div>
      <button
        ...
        disabled={loading}
        className="flex shrink-0 items-center gap-1.5 rounded-xl bg-amber-500 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-400 transition-colors disabled:opacity-50"
      >
