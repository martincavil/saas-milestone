...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="border-t border-gray-100 bg-gray-50 p-8 md:py-16">
      <div className="mx-auto max-w-5xl px-5">
        ...
        {/* Billing switch */}
        <ScrollReveal className="mb-8 flex justify-start">
          <div className="inline-flex items-center gap-1 rounded-xl border border-gray-200 bg-white p-1 shadow-sm">
            ...
            >
              ...
              <span className={`rounded-full px-2 py-0.5 text-xs font-semibold transition-colors ${
                isAnnual ? 'bg-green-500/20 text-green-300' : 'bg-green-100 text-green-700'
              }`}>
                Save 27%
              </span>
            </button>
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-3.5 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-amber-700 mt-0.5">
                  Lock in <strong>$49/year forever</strong> instead of $79/year. Only <strong>50 spots</strong> at this price.
                </p>
              </div>
              <Link
                href="/login"
                className="flex-shrink-0 rounded-xl bg-amber-500 px-4 py-2 text-xs font-bold text-white hover:bg-amber-400 transition-colors whitespace-nowrap"
              >
                Claim $49/yr →
              </Link>
            </div>
        ...
        {/* Cards */}
        <div className={`grid max-w-3xl gap-4 mx-auto ${isAnnual ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
          ...
          <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <Link href="/login" className="btn-secondary block w-full justify-center text-center">
              Get started
            </Link>
          </div>
          ...
          {isAnnual && (
            <div className="flex flex-col relative overflow-hidden rounded-2xl border-2 border-amber-400 bg-white p-6 shadow-lg">
              ...
              <div className="absolute right-3 top-3">
                <span className="rounded-full bg-amber-400 px-2 py-0.5 text-xs font-bold text-white">50 spots</span>
              </div>
              ...
              <p className="mb-0.5 text-xs text-gray-400 line-through">$79/year</p>
              <p className="mb-5 text-xs font-semibold text-amber-600">Locked forever · save 38%</p>
              <ul className="mb-6 space-y-2.5 flex-1">
              ...
              <Link
                href="/login"
                className="flex items-center justify-center gap-2 rounded-xl bg-amber-500 py-2.5 text-sm font-bold text-white hover:bg-amber-400 transition-colors"
              >
                Claim your spot
              </Link>
            </div>
          ...
          <div className="flex flex-col relative overflow-hidden rounded-2xl bg-gray-900 p-6 text-white shadow-xl">
            ...
            <div className="relative flex flex-col h-full">
              ...
              {isAnnual ? (
                <>
                  <div className="mb-1 flex items-end gap-1">
                    <span className="text-4xl font-extrabold text-white font-poppins">$79</span>
                    <span className="mb-1.5 text-sm text-gray-400">/year</span>
                  </div>
                  <p className="mb-0.5 text-xs text-gray-500 line-through">$108/year</p>
                  <p className="mb-5 text-xs text-indigo-400 font-medium">Save 27% vs monthly</p>
                </>
              ) : (
                <>
                  <div className="mb-1 flex items-end gap-1">
                  ...
                  <p className="mb-5 text-xs text-gray-500">After $100 MRR · cancel anytime</p>
                </>
              )}
              <ul className="mb-6 space-y-2.5 flex-1">
                {PRO_FEATURES.map(f => (
